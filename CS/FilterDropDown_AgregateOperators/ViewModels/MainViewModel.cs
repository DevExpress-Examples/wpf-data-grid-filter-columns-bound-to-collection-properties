...
namespace FilterDropDown_AgregateOperators.ViewModels {
    ...
    public class GridData {
        public static List<Object> GetGenres() {
            return new List<Object>(Enumerable.Range(0, 10).Select(c => new Genre() { Value = c, Name = "Genre #" + c }));
        }
        public static ObservableCollection<ClassName> GetDataItems(IList<object> genres) {
